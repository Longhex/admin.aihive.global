...
import { ExpiringAccountsTable, getTotalExpiringAccounts } from "@/components/dashboard/ExpiringAccountsTable"
import { ArrowUpRight, UserCheck, UserX, AlertCircle } from "lucide-react"
    ...
    <Layout>
      {usingFallbackData && (
        <Alert variant="warning" className="mb-6">
          ...
          <AlertDescription>
            Unable to connect to the live API. Showing demo data for preview purposes.
          </AlertDescription>
        </Alert>
      )}
      ...
      <div className="flex flex-col gap-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="bg-gray-900 border-gray-800 rounded-xl overflow-hidden">
            <CardHeader className="border-b border-gray-800 p-6">
              <div className="flex justify-between items-center">
                <CardTitle className="text-base font-normal text-white">Users</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="p-6">
              <div className="flex flex-col">
                <div className="flex items-baseline space-x-3">
                  <div className="text-4xl font-bold text-white">{totalUsers || 0}</div>
          ...
          <MetricCard
            ...
            value={expiredAccounts !== null ? expiredAccounts.toString() : "Loading..."}
          ...
          <MetricCard
            ...
            value={totalExpiringAccounts !== null ? totalExpiringAccounts.toString() : "Loading..."}
