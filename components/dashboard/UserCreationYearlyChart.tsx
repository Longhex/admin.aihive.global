      ...
      <CardHeader className="border-b border-gray-800 p-6">
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <CardTitle className="text-base font-normal text-white">User Creation by Month</CardTitle>
        ...
        {loading ? (
          ...
          <ResponsiveContainer width="100%" height={400}>
            <BarChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
              ...
              />
              <Legend />
              <Bar dataKey="count" fill="#a78bfa" name={`${selectedYear} Users`} radius={[4, 4, 0, 0]}>
