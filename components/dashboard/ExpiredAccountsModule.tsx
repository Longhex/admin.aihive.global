      ...
      try {
        ...
        const res = await axios.get("/api/users", {
          params: {
            expiring: true,
            page: currentPage,
            pageSize: showAll ? 10000000 : itemsPerPage,
          },
        });
        const data = res.data;
          ...
          <>
            <div className="mb-4">
              <p className="text-xl font-bold text-white">
                Total Expired Accounts: {totalExpiringAccounts}
              </p>
            </div>
            {totalExpiringAccounts > 0 ? (
              <>
                ...
                <div className="mt-4 flex justify-between items-center">
                  ...
                  <span className="text-gray-300">
                    Page {currentPage} of{" "}
                    {Math.ceil(totalExpiringAccounts / itemsPerPage)}
                  </span>
                  <Button
                    onClick={() =>
                      setCurrentPage((prev) =>
